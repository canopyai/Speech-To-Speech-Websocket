...
class AbstractClient {
    constructor(key, options) {
        ...
        if (!((_a = this.options.global) === null || _a === void 0 ? void 0 : _a.url)) {
            throw new errors_1.DeepgramError(`An API URL is required. It should be set to ${constants_1.DEFAULT_URL} by default. No idea what happened!`);
        }
        if (this.willProxy()) {
            if (this.key !== "proxy") {
                throw new errors_1.DeepgramError(`Do not attempt to pass any other API key than the string "proxy" when making proxied REST requests. Please ensure your proxy application is responsible for writing our API key to the Authorization header.`);
            }
            this.baseUrl = this.resolveBaseUrl((_b = this.options.restProxy) === null || _b === void 0 ? void 0 : _b.url);
