...
export declare const StartRecognitionMessageEnum: {
    readonly StartRecognition: "StartRecognition";
};
export type StartRecognitionMessageEnum = typeof StartRecognitionMessageEnum[keyof typeof StartRecognitionMessageEnum];
