...
export declare class RealtimeSession {
     ...
     */
    addListener<MessagesEnum extends keyof EventMap>(event: MessagesEnum, listener: EventMap[MessagesEnum]): void;
    /**
     ...
     */
    removeListener<MessagesEnum extends keyof EventMap>(event: MessagesEnum, listener: EventMap[MessagesEnum]): void;
    /**
